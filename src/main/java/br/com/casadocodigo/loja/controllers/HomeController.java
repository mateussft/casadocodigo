...
//Método que popula o banco usando os dados da url magica
	@ResponseBody
	@RequestMapping("/url-magica-maluca-oajksfbvad6584i57j54f9684nvi658efnoewfmnvowefnoeijn")
	@Transactional
	public String urlMagicaMaluca() {

		Produto produto1 = criarProduto(502, new GregorianCalendar(2016, 6, 15), "Java SE 8 Programmer I",
				"O guia para sua certificação Oracle Certified Associate", new String[] { "29.9", "39.9", "79.9" });
		Produto produto2 = criarProduto(172, new GregorianCalendar(2017, 11, 21), "Orientação a Objetos",
				"Aprenda seus conceitos e suas aplicabilidades de forma efetiva",
				new String[] { "29.9", "49.9", "59.9" });
		Produto produto3 = criarProduto(260, new GregorianCalendar(2018, 2, 2), "Spring MVC",
				"Domine o principal framework web Java", new String[] { "19.9", "29.9", "39.9" });
		Produto produto4 = criarProduto(234, new GregorianCalendar(2017, 11, 11), "Amazon AWS",
				"Descomplicando a computação na nuvem", new String[] { "29.9", "69.9", "79.9" });
		Produto produto5 = criarProduto(355, new GregorianCalendar(2018, 7, 2),
				...
				new String[] { "29.9", "69.9", "79.9" });
		Produto produto6 = criarProduto(151, new GregorianCalendar(2017, 3, 4), "Java 8 Prático",
				"Lambdas, Streams e os novos recursos da linguagem", new String[] { "19.9", "49.9", "69.9" });
...
//criando e gravando as roles
		...
		return "Url Mágica executada. Banco populado e pronto para testes!";
	}
//cria os produtos da url
